...
3. Perform top-_k_ nearest neighbor search in FAISS
...
The following figure shows the web-based chat interface used to interact with the Open Domain Question Answering (ODQA) system. Users can ask questions in natural language and receive concise answers generated by the system.

<p align="center">
  <img src="ui.png" alt="ODQA Web Interface" width="900"/>
</p>

**Figure:** Web-based chat interface for interacting with the ODQA system.
...
2. Cosine similarity search retrieves top-_k_ passages via FAISS
